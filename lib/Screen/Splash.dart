    ...
    if (uid == null || uid == "") {
      ...
      Future.delayed(Duration(seconds: 3), () async {
        ...
        if (checkIn ?? false) {
          ...
          DateTime autoCheckOutDateTime = await DateTime(DateTime.now().year,
          ...
          if (checkInDateTime.isBefore(autoCheckOutDateTime) &&
              DateTime.now().isAfter(autoCheckOutDateTime)) {
            await getCurrentLoc();
            await checkOutNow();
            // Navigator.pushReplacementNamed(context, "/home");
            Navigator.push(
