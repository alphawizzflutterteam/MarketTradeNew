  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Counter Visit View", style: TextStyle(fontSize: 17, color: Colors.white, fontWeight: FontWeight.w800),),
      ),
      body: widget.model == null ? Center(child: CircularProgressIndicator()) : Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Center(
                          child: InkWell(
                            onTap: () {
                              final imageProvider = Image.network(widget.model?.photo?.first ?? "").image;
                            ...
                            child: Container(
                              ...
                              width: 300,
                              child: ClipRRect(
                                  child: Image.network("${widget.model?.photo?.first}",fit: BoxFit.fill,)),
                            ),
                          ),
                        ),
                        SizedBox(height: 10),
                        Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Text("Firm Name:", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black)),
                                SizedBox(width: 10,),
                                Text("${widget.model?.firmname??""}", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w200, color: Colors.black))
                              ],
                            ),
                            SizedBox(height: 5,),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("Owner Name:", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black),),
                                Text("${widget.model?.basicDetail?.name??""}", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w200, color: Colors.black))
                              ],
                            ),
                            SizedBox(height: 5,),
                            Row(
                              // mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("Address:", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black)),
                                SizedBox(width: 64,),
                                Text("${widget.model?.basicDetail?.address??""}",style: TextStyle(fontSize: 14, fontWeight: FontWeight.w200, color: Colors.black),
                                ...
                                InkWell(
                                    ...
                                    child: Icon(Icons.location_disabled, color: colors.primary,)),
                              ],
                            ),SizedBox(height: 5,),
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              ...
                              children: [
                                Text("Customer Type:",style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black)),
                                Text("${widget.model?.basicDetail?.customerType??""}",style: TextStyle(fontSize: 14, fontWeight: FontWeight.w200, color: Colors.black))
                              ],
                            ),SizedBox(height: 5,),
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("Mobile Number:",style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black)),
                                Text("${widget.model?.basicDetail?.mobile??""}",style: TextStyle(fontSize: 14, fontWeight: FontWeight.w200, color: Colors.black))
                              ],
                            ),
                            SizedBox(height: 5,),
                            Row(
                              ...
                              children: [
                                ...
                                Text("${widget.model?.username??""}",style: TextStyle(fontSize: 14, fontWeight: FontWeight.w200, color: Colors.black))
                              ],
                            ),SizedBox(height: 5,),
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("Date & Time:", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black)),
                                Text("${widget.model?.date??""}${widget.model?.time ??""}",
                                  style: TextStyle(fontSize: 14, fontWeight: FontWeight.w200, color: Colors.black), maxLines: 2, overflow: TextOverflow.ellipsis,)
                              ],
                            ),SizedBox(height: 5,),
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              ...
                              children: [
                                Text("Latitude:", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black)),
                                Text("${widget.model?.lat??""}",
                                  style: TextStyle(fontSize: 14, fontWeight: FontWeight.w200, color: Colors.black), maxLines: 2, overflow: TextOverflow.ellipsis,)
                              ],
                            ),
                            SizedBox(height: 5,),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("Longitude:", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black)),
                                Text("${widget.model?.lng??""}",
                                  style: TextStyle(fontSize: 14, fontWeight: FontWeight.w200, color: Colors.black), maxLines: 2, overflow: TextOverflow.ellipsis,)
                              ],
                            ),
                            SizedBox(height: 5,),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("Grievance:", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black)),
                                Text("${widget.model?.grivenance??""}",
                                  style: TextStyle(fontSize: 14, fontWeight: FontWeight.w200, color: Colors.black), maxLines: 2, overflow: TextOverflow.ellipsis,)
                              ],
                            ),
                            SizedBox(height: 5,),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("Remarks:", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black)),
                            ...
                            SizedBox(height: 10,),
                                ListView.builder(
                                    shrinkWrap: true,
                                    itemCount: widget.model?.survey?.length ?? 0,
                                    physics: NeverScrollableScrollPhysics(),
                                    itemBuilder: (_,i){
                                      monthlyCtr[i].text= widget.model?.survey?[i].monthlySale ?? "";
                                      currentStockCtr[i].text= widget.model?.survey?[i].currentStock ?? "";
                                      wspCtr[i].text= widget.model?.survey?[i].wps ?? "";
                                      rspCtr[i].text= widget.model?.survey?[i].rsp ?? "";
                                      purchasingFormCtr[i].text= widget.model?.survey?[i].purchasingFrom ?? "";
                                      return Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              Text("Brand Name:",style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black),),
                                              Text("${widget.model?.survey?[i].brandName}",style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black),),
                                            ],
                                          ),
                                          ...
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              Text("Monthly Sale:",style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black)),
                                              Container(
                                                height: 30,
                                          ...
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              Text("WPS:",style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black)),
                                              Container(
                                                height: 30,
                                                width: MediaQuery.of(context).size.width/2.9,
                                                child: TextField(
                                          ...
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              Text("RSP:",style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black)),
                                              Container(
                                                height: 30,
                                                width: MediaQuery.of(context).size.width/2.9,
                                                child: TextField(
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: TextField(
                                                  readOnly: true,
                                                  controller:purchasingFormCtr[i],
                                                  keyboardType: TextInputType.number,
                                                  decoration: InputDecoration(
                                                    contentPadding: EdgeInsets.only(top: 7, left: 5),
                                                    border: OutlineInputBorder(
