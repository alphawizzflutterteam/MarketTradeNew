                  ...
                  Center(
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        width: 350,
                        child: ClipRRect(
                            child: widget.model?.photo?.first == null || widget.model!.photo!.first.isEmpty ?
                                Image.asset("assets/images/placeholder.png"):
                            Image.network("${widget.model?.photo?.first}",fit: BoxFit.fill,)),
                      ),
                    ),
                  ),
                  SizedBox(height: 10),
                  ...
                  SizedBox(
                    child: ListView.builder(
                      ...
                      itemCount:widget.model?.survey?.length ,
                        itemBuilder: (_,i){
                          producyNameCtr[i].text= widget.model?.survey?[0].brandName ?? "";
                          totalConusmptionCtr[i].text= widget.model?.survey?[i].totalConsumption ?? "";
                          furtherCusmptionCtr[i].text= widget.model?.survey?[i].furtherConsumption ?? "";
                          purchasePriceCtr[i].text= widget.model?.survey?[i].purchasePrice ?? "";
                          purchaseFormCtr[i].text= widget.model?.survey?[i].purchasingFrom ?? "";
                          lastpurchaseCtr[i].text= widget.model?.survey?[i].lastPurchaseDate ?? "";
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text("Total Consumption: ",style: TextStyle(fontSize: 15)),
                                  Container(
                                    height: 30,
                                    width: MediaQuery.of(context).size.width/2.9,
                                    child: TextField(
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text("Further Consumption: ",style: TextStyle(fontSize: 15)),
                                  Container(
                                    height: 30,
                                    width: MediaQuery.of(context).size.width/2.9,
                                    child: TextField(
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text("Purchasing From:",style: TextStyle(fontSize: 15)),
                                  Container(
                                    height: 30,
                                    width: MediaQuery.of(context).size.width/2.9,
                                    child: TextField(
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text("Last Purchase Date: ",style: TextStyle(fontSize: 15)),
                                  Container(
                                    height: 30,
                                    width: MediaQuery.of(context).size.width/2.9,
                                    child: TextField(
