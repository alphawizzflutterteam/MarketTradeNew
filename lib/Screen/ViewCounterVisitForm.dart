                             ...
                             children: [
                               SizedBox(
                                 ...
                                 child: Row(
                                   ...
                                   children: [
                                     ...
                                     Text("${getdata?.data?[index].firmname??""}", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w200, color: Colors.black))
                                   ],
                                 ),
                               ),
                               SizedBox(
                                 ...
                                 child: Row(
                                   ...
                                   children: [
                                     ...
                                     SizedBox(
                                         child: Text("${getdata?.data?[index].basicDetail?.name??""}", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w200, color: Colors.black)))
                                   ],
                                 ),
                               ),
                               SizedBox(
                                 ...
                                 child: Row(
                                   ...
                                   children: [
                                     ...
                                     Text("${getdata?.data?[index].basicDetail?.customerType??""}",style: TextStyle(fontSize: 14, fontWeight: FontWeight.w200, color: Colors.black))
                                   ],
                                 ),
                               ),
                               SizedBox(
                                 ...
                                 child: Row(
                                   mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                   children: [
                                     Text("Visited By:", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black)),
                                     Text("${getdata?.data?[index].username??""}",style: TextStyle(fontSize: 14, fontWeight: FontWeight.w200, color: Colors.black))
                                   ],
                                 ),
                               ),
                               SizedBox(
                               ...
                               SizedBox(
                                 ...
                                 child: Row(
                                   mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                   children: [
                                     Text("Time:", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black)),
                                     Text("${getdata?.data?[index].time ??""}",
                                       style: TextStyle(fontSize: 14, fontWeight: FontWeight.w200, color: Colors.black), maxLines: 2, overflow: TextOverflow.ellipsis,),
                                   ],
                                 ),
                               ),
                          ...
                          children: [
                              ...
                              child: Row(
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: Text("${getdata?.data?[index].basicDetail?.address??""}",style: TextStyle(fontSize: 14, fontWeight: FontWeight.w200, color: Colors.black),
                            ...
                            InkWell(
                              ...
                              child: Container(
                                  ...
                                  child: Center(child: Text("View", style: TextStyle(fontSize: 15, color: Colors.white, fontWeight: FontWeight.w600)))),
                            ),
                          ],
                        ),
                        // Center(
