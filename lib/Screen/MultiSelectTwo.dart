...
class MultiSelectTwo extends StatefulWidget {
  ...
  // required this.type
  MultiSelectTwo({Key? key, this.dealingData, this.name, this.email,this.contact,this.creditLimit, this.customerType,this.time, this.date,this.image, this.remark, this.clientId }) : super(key: key);
  @override
  State<StatefulWidget> createState() => _MultiSelectTwoState();
}
class _MultiSelectTwoState extends State<MultiSelectTwo> {
